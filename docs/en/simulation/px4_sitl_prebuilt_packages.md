...
The standalone `ghcr.io/px4/px4-dev-ros2:main-jazzy` toolchain provides the same build tools and precloned ROS sources without bundled firmware or a compiled workspace.
